...
use App\Http\Resources\Api\Website\Home\SimpleProductResource;
...
class SliderItemResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        if($this->item_type != 'products') {
            ...
            $products = Product::whereIn('id',json_decode($this->item_id))->get();
        }
        ...
        return [
            ...
            'item' => $item,           
            'products' => $products != null ? SimpleProductResource::collection($products) : null, 
        ];
    }
}
