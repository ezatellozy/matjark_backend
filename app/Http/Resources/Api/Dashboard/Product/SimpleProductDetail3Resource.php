...
class SimpleProductDetail3Resource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        // $get_apply = $this->merge(static::$using)->data['get_apply'];
        ...
        //     ],
        //     'product_details_show' => OfferProductDetailResource::collection($get_apply),
