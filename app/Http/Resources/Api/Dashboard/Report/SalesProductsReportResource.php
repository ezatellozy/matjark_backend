...
class SalesProductsReportResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        $total_qty = OrderProduct::where('product_id',$this->product_id)->whereHas('order',function($order) {
        ...
        $total_price = OrderProduct::where('product_id',$this->product_id)->whereHas('order',function($order) {
        ...
        $order_products = OrderProduct::where('product_id',$this->product_id)->whereHas('order',function($order) {
