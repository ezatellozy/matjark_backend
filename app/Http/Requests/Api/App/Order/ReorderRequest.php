    ...
    public function rules()
    {
        ...
        if ($orderProducts) {
            foreach ($orderProducts as $orderProduct) {
                ...
                $offerMessage = $orderProduct->offer_id != null ?  $this->CheckOfferIsValide('cart', $orderProduct->offer_id) :  '';
                ...
                $flashSaleMessage = $orderProduct->flash_sale_product_id != null ?  $this->CheckFlashSaleIsValide('cart', $orderProduct->flash_sale_product_id) : '';
