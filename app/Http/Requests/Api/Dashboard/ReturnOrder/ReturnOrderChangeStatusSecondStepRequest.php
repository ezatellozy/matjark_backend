...
namespace App\Http\Requests\Api\Dashboard\ReturnOrder;

use App\Http\Requests\Api\ApiMasterRequest;
use App\Models\ReturnOrder;
use Illuminate\Http\Exceptions\HttpResponseException;

class ReturnOrderChangeStatusSecondStepRequest extends ApiMasterRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            ...
            'return_order_products.*.return_order_product_id' => 'required|exists:return_order_products,id,status,accepted',
            "return_order_products.*.status"                  => "required|in:rejected,received",
