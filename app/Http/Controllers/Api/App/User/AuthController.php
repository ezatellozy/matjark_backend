...
use App\Http\Requests\Api\App\User\{AddPhoneRequest, CheckCodeRequest, CheckPhoneCodeRequest, EditPhoneRequest, EditProfileRequest, ForgetPasswordRequest, LoginRequest, LogoutRequest, RegisterRequest, ResendCodeRequest, ResetPasswordRequest, UpdateLangRequest, UpdatePasswordRequest, UpdatePhoneRequest, VerifyCodeRequest, VerifyRequest};
use App\Http\Resources\Api\App\User\{UserResource};
use App\Models\{Profile, User, Device, Phone, Wallet};
use App\Traits\Cart;
    ...
    public function resendCode(ResendCodeRequest $request)
    {
        ...
        try {
            if ($request->type == 'register') {
                if (setting('verification_type') && setting('verification_type') == 'email') {
