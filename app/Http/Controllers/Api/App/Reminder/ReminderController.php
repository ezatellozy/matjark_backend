...
namespace App\Http\Controllers\Api\App\Reminder;

use App\Http\Controllers\Controller;
use App\Http\Requests\Api\App\Reminder\ReminderRequest;
...
class ReminderController extends Controller
{
    ...
    public function reminder(ReminderRequest $request)
    {
        ...
        return response()->json(['data' => ['is_reminder' => $is_reminder], 'status' => 'success', 'message' => trans('app.messages.reminder_successfully')]);
    }
}
