...
namespace App\Http\Controllers\Api\App\Favourite;

use App\Http\Controllers\Controller;
use App\Http\Requests\Api\App\Favourite\FavRequest;
...
class FavouriteController extends Controller
{
    ...
    public function fav(FavRequest $request)
    {
        ...
        // dd(FavouriteProduct::where(['user_id' => auth('api')->id(), 'product_detail_id' => $request->product_detail_id])->orWhere(['guest_token' => $request->guest_token, 'product_detail_id' => $request->product_detail_id])->exists());
        // if (FavouriteProduct::where(['user_id' => auth('api')->id(), 'product_detail_id' => $request->product_detail_id])->orWhere(['guest_token' => $request->guest_token, 'product_detail_id' => $request->product_detail_id])->exists()) {
        //     FavouriteProduct::where(['user_id' => auth('api')->id(), 'product_detail_id' => $request->product_detail_id])->orWhere(['guest_token' => $request->guest_token, 'product_detail_id' => $request->product_detail_id])->delete();
        //     $is_fav = false;
        // } else {
        //     FavouriteProduct::create(['user_id' => auth('api')->id(), 'guest_token' => $request->guest_token, 'product_detail_id' => $request->product_detail_id]);
        //     $is_fav = true;
        // }
