...
use App\Http\Requests\Api\App\Order\{RateRequest};
use App\Http\Resources\Api\App\Rate\{RateResource, SimpleRateResource};
...
class RateController extends Controller
{
    public function store(RateRequest $request, $order_id)
    {
        try {
            ...
            $arr = ['status' => setting('review_rates') == 'automatically' ? 'accepted' : 'pending', 'user_id' => auth('api')->id(), 'order_id' => $order_id];
