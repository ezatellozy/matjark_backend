...
namespace App\Http\Controllers\Api\Provider\Country;

use App\Http\Controllers\Controller;
use App\Http\Requests\Api\Provider\Country\CountryRequest;
...
class CountryController extends Controller
{
    ...
    public function store(CountryRequest $request)
    {
        ...
        return CountryResource::make($country)->additional(['status' => 'success', 'message' => trans('provider.create.country')]);
    }
    ...
    public function update(CountryRequest $request, $id)
    {
        ...
        return CountryResource::make($country)->additional(['status' => 'success', 'message' => trans('provider.update.country')]);
    }
    ...
    public function destroy($id)
    {
        ...
        if ($country->delete()) {
            return response()->json(['status' => 'success', 'data' => null, 'messages' => trans('provider.delete.country')]);
        }
    ...
    public function statistics($countries)
    {
        ...
        foreach ($cards as $k => $v) {
            $data[] = [
                'id'    => $i++,
                'name'  => trans('provider/api.statistics.' . $k),
                'value' => $v,
            ];
        }
        return $data;
