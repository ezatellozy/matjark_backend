...
namespace App\Http\Controllers\Api\Dashboard\Coupon;

use App\Http\Controllers\Controller;
use App\Http\Requests\Api\Dashboard\Coupon\CouponRequest;
use App\Http\Resources\Api\Dashboard\Coupon\{CouponDetailResource, CouponResource, CouponV2Resource, SimpleCouponResource};
...
class CouponController extends Controller
{
    ...
    public function store(CouponRequest $request)
    {
        ...
        return CouponV2Resource::make($coupon)->additional(['status' => 'success', 'message' => trans('dashboard.create.success')]);
    }
    ...
    public function couponAdditionDataOrders($id)
    {
        ...
        // })->paginate();
        $orders = Order::where('status', 'pending')->whereHas('orderCoupon', function ($q) use ($id) {
            $q->where('coupon_id', $id);
        })->paginate();
    ...
    {
        $coupon = Coupon::findOrFail($id);
        return CouponV2Resource::make($coupon)->additional(['status' => 'success', 'message' => '']);
    }
    ...
    public function update(CouponRequest $request, $id)
    {
        ...
        try {
            ...
            return CouponV2Resource::make($coupon)->additional(['status' => 'success', 'message' => trans('dashboard.update.success')]);
        } catch (Exception $e) {
