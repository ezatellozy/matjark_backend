...
use App\Http\Requests\Api\Dashboard\Wallet\WithdrawalRequest;
        ...
        try {
            switch ($request->status) {
                case 'accepted':
                    ...
                    {
                        return response()->json(['status' => 'fail', 'data' => null, 'message' => trans('dashboard.withdrawal.user_wallet_less_than_requested_amount')]);
                    }
