...
namespace App\Http\Controllers\Api\Dashboard\Size;

use App\Http\Controllers\Controller;
use App\Http\Requests\Api\Dashboard\Size\SizeRequest;
...
class SizeController extends Controller
{
    ...
    public function store(SizeRequest $request)
    {
        ...
        return (new SizeResource($size))->additional(['status' => 'success', 'message' => trans('dashboard.create.success')]);
    }
    ...
    public function update(SizeRequest $request, $id)
    {
        ...
        return SizeResource::make($size)->additional(['status' => 'success', 'message' => trans('dashboard.update.success')]);
    }
