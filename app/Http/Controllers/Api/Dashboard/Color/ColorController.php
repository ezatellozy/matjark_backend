...
namespace App\Http\Controllers\Api\Dashboard\Color;

use App\Http\Controllers\Controller;
use App\Http\Requests\Api\Dashboard\Color\ColorRequest;
...
class ColorController extends Controller
{
    ...
    public function store(ColorRequest $request)
    {
        ...
        return (new ColorResource($color))->additional(['status' => 'success', 'message' => trans('dashboard.create.success')]);
    }
    ...
    public function update(ColorRequest $request, $id)
    {
        ...
        return (new ColorResource($color))->additional(['status' => 'success', 'message' => trans('dashboard.update.success')]);
    }
    ...
    public function destroy($id)
    {
        ...
        if ($color->delete()) {
            return response()->json(['status' => 'success', 'data' => null, 'messages' => trans('dashboard.delete.color')]);
        }
