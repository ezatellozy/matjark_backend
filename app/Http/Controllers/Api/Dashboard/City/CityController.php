...
use App\Http\Resources\Api\Dashboard\District\DistrictResource;
use App\Http\Resources\Api\Dashboard\District\DistrictSimpleResource;
use App\Models\City;
...
class CityController extends Controller
{
    ...
    public function store(CityRequest $request)
    {
        ...
        return CityResource::make($city->fresh())->additional(['status' => 'success', 'message' => trans('dashboard.create.city')]);
    }
    ...
    public function update(CityRequest $request, $id)
    {
        ...
        return CityResource::make($city)->additional(['status' => 'success', 'message' => trans('dashboard.update.city')]);
    }
    ...
    public function destroy($id)
    {
        ...
        if ($city->delete()) {
            return response()->json(['status' => 'success', 'data' => null, 'messages' => trans('dashboard.delete.city')]);
        }
    ...
    public function statistics($request)
    {
        ...
        foreach ($cards as $k => $v) {
            $data[] = [
                'id'    => $i++,
                'name'  => trans('dashboard.statistics.' . $k),
                'value' => $v,
            ];
        }
        return $data;
