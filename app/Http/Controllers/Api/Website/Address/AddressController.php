...
namespace App\Http\Controllers\Api\Website\Address;

use App\Http\Controllers\Controller;
use App\Http\Requests\Api\Website\Address\{AddressRequest, IsDefaultRequest};
use App\Http\Resources\Api\Website\Address\{AddressResource, SimpleAddressResource};
...
class AddressController extends Controller
{
    ...
    public function index()
    {
        ...
        return (SimpleAddressResource::collection($addresses))->additional(['status' => 'success', 'message' => '']);
    }
